...
import FormComponent from './components/alquileres/FormComponent.vue';
import RentasList from './components/alquileres/RentasList.vue';
app.component('example-component', ExampleComponent);
app.component('marca-component',MarcaComponent);
app.component('auto-component',AutoComponent);
app.component('form-component',FormComponent);
app.component('rentas-list',RentasList);
